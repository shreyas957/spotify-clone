...
@Component({
  ...
  template: `
    <div class="album-container" *ngIf="!isLoading && tracks.length > 0">
      <div class="album-header">
        <div class="album-cover">
          <img [src]="getAlbumImage()" [alt]="getAlbumName()" loading="lazy">
        </div>
        <div class="album-info">
          <p class="album-type">{{ getAlbumType() }}</p>
          <h1 class="album-title">{{ getAlbumName() }}</h1>
          <div class="album-meta">
            <span class="album-artist">{{ getArtistNames() }}</span>
            <span class="separator">•</span>
            <span class="album-year">{{ getAlbumYear() }}</span>
            <span class="separator">•</span>
    ...
    <div *ngIf="isLoading" class="loading-container">
      ...
      <p class="loading-text">Loading album tracks...</p>
    </div>
    ...
    <div *ngIf="!isLoading && tracks.length === 0" class="error-container">
      <div class="error-content">
        ...
        <p>This album doesn't have any tracks available.</p>
      </div>
    </div>
    <app-track-player
      *ngIf="showPlayer"
...
export class AlbumComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.params.subscribe(params => {
      ...
      console.log('Album ID:', this.albumId); // Debug log
  ...
  loadAlbumTracks(): void {
    ...
    console.log('Loading tracks for album:', this.albumId); // Debug log
    
    this.musicService.getAlbumTracks(this.albumId).subscribe({
      next: (tracks) => {
        console.log('Received tracks:', tracks); // Debug log
        this.tracks = tracks;
